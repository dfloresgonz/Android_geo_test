...
/**
 * Created by dflores on 24/02/2016.
 */
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    MyAdapter(String Titles[],int Icons[],String Name,String Email, int Profile, Context context){ // MyAdapter Constructor with titles and icons parameter
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            MapaVariables.enBusqueda = true;
            Log.d("BUHOO", " CLICKKKKKKKKKKKKKKKKKKKKKKKKKKKK   " + actividad + "  ..... ::   " + MapaVariables.enBusqueda);
    ...
    public void onBindViewHolder(MyAdapter.ViewHolder holder, int position) {
        if(holder.Holderid == 1) {                              // as the list view is going to be called after the header view so we decrement the
            ...
            holder.setItem(mNavTitles[position - 1]);
        } else {
